    ...
    <>
      ...
      <section className="hero">
        <div className="container hero__inner" style={{ gridTemplateColumns: "1fr" }}>
          <div>
            <h1 className="hero__title" style={{ marginBottom: "10px" }}>Sign Up</h1>
            <p className="hero__subtitle">Create your LexSutra account.</p>
            <div className="crumb">
              <Link to="/">Home</Link>
              <span className="crumb__sep">›</span>
              <span className="crumb__current">Sign Up</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container" style={{ maxWidth: "760px" }}>
          <div className="card">
            ...
            <div style={{ marginTop: "14px" }}>
              ...
              <Link to="/login" style={{ textDecoration: "none", color: "var(--gold)", fontWeight: 900 }}>
                Login →
              </Link>
            </div>
          </div>
